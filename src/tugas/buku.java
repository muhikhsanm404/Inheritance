...
public class buku {
    ...
    public static String getJudulBuku(int i) {  // get untuk mendapatkan , static agar tidak buat objek baru lagi , int i mendapatkan index via parameter
        return judulBuku[i];   // mengembalikan nilai judulBuku[i] ke tempat panggilnya di panggil di kelas mainnya yang looping lihatBuku
    }
